    ...
    return (
        <>
            ...
            <input
                ...
                onBlur={e => updateHandle(name, handle)}
            />
            <button className='text-3xl ml-6 outline-none hover:text-indigo-400 focus:text-indigo-400 transition duration-300 ease-in-out' onClick={() => toggleInput(name)}>×</button>
        </>
    )
>>>>>>> main
}
